...
description: >-
  ...
  assessments from an already defined scope, prerequisites, outcomes, and supplied context.
  Use for actual textbook authoring or substantial deepening of thin material. Do not perform
  external research, design curriculum, choose sources, or decide storage and publishing
  policy.
---
...
Preserve the supplied scope, prerequisites, learning outcomes, terminology, and evidence. Make
local pedagogical choices when needed, but do not turn authoring into research or curriculum
design.
...
facts but rebuild the missing teaching layers. Do not merely paraphrase, add headings, or add
more examples.
