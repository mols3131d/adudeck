...
description: >-
  ...
  depth, chapter quality, exercises, assessment, or deciding whether material qualifies as a
  textbook. Do not use for external research, curriculum design, source collection, storage,
  or writing the textbook prose; use adudeck-textbook-write for authoring.
---
...
and evidence as upstream inputs. Do not research, expand the curriculum, choose sources, write
the actual textbook prose, or decide where it is stored or published.
...
- checkpoints, cumulative work, and assessment aligned with the stated learning outcomes.
...
- Do not hide essential explanation inside exercises.
...
- assessment unrelated to the stated outcomes;
- notes, glossary, cheat sheet, tutorial, outline, or blog-style explanation presented as a
  textbook.

The material qualifies only when its explanation, examples, and practice together can serve as
the learner's main path to competence for the defined scope.

## Routing

Use `adudeck-textbook-write` to write or revise textbook prose, chapters, worked examples,
exercises, labs, or assessments.
